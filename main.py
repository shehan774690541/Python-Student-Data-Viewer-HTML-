...
window.title("student mark writer | shehan774690541@gmail.com")
...
comboexsam = Combobox(window,width=5)
...
combofs = Combobox(window,width=5)
combofs['values']= ("ICT", "Agree")
combofs.current(0)
combofs.grid(column=1, row=8)

txtfs = Entry(window,width=5)
...
comboss = Combobox(window,width=5)
comboss['values']= ("ET", "BST")
comboss.current(0)
comboss.grid(column=1, row=9)

txtss = Entry(window,width=5)
...
comboms = Combobox(window,width=5)
comboms['values']= ("SFT", "Other")
comboms.current(0)
comboms.grid(column=1, row=10)

txtms = Entry(window,width=5)
...
btncal = Button(window, text="Calculate", command=calculate,width=8)
btncal.grid(column=0, row=18)
btncal = Button(window, text="Clear Deta", command=clearDeta,width=6)
btncal.grid(column=1, row=18)
btncal = Button(window, text="Clear Html", command=clearHtmlFile,width=6)
btncal.grid(column=2, row=18)

#save a file
saveTable = Button(window, text="Save HTML", command=saveHtml,width=6)
saveTable.grid(column=1, row=19)
# dqfile = "index"
fileName_html = ""
fileName_html = Entry(window,width=12)
fileName_html.grid(column=0, row=19)
btncal = Button(window, text="Basic Code", command=basicCode,width=6)
